          ...
          <Row className="additional-info">
            <Col md="12">
              ...
              <p className="contact-info">
                <strong>Contact Information:</strong> For inquiries, contact our support at atlascrossings@gmail.com. Visit our tracking portal for real-time updates and additional information.
              </p>
            </Col>
          </Row>
        </Container>
