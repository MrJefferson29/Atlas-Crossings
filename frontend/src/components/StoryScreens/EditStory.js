...
const EditStory = () => {
    ...
    useEffect(() => {
        ...
        const getStoryInfo = async () => {
            setLoading(true)
            try {
                const { data } = await axios.get(`https://atlas-crossings.onrender.com/story/editStory/${slug}`, config)
                setStory(data.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.put(`https://atlas-crossings.onrender.com/story/${slug}/edit`, formdata, config)
                            ...
                            <div class="currentlyImage">
                                <div class="absolute">
                                    Currently Image
                                        ...
                                        <img src={`https://atlas-crossings.onrender.com/storyImages/${previousImage}`} alt="storyImage" />
                            </div>
