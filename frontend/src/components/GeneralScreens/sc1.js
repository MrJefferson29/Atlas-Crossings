  ...
  return (
    <Styles>
      ...
      <QuoteSection>
        ...
        <QuoteText>
          At Atlas Crossings, we believe logistics is more than just moving goods—it's about moving businesses forward. Our mission is simple: to deliver reliability, innovation, and exceptional service every step of the way.
        </QuoteText>
