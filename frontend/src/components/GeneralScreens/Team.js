...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "In today's fast-paced digital world, e-commerce businesses need logistics partners that can keep up with their growth. Atlas Crossings offers tailored solutions for online retailers, including same-day delivery, returns management, and real-time tracking.",
  ...
  return (
    <Styles>
      ...
      <CoreServicesSection>
        ...
        <Separator />
        <IntroText>
          At Atlas Crossings, we offer a comprehensive range of logistics services designed to meet the diverse needs of our clients. From domestic shipments to international freight, we've got you covered. Here's a closer look at what we do:
        </IntroText>
      </CoreServicesSection>
      ...
      <WhyChooseSection>
        ...
        <Separator />
        <WhyChooseText>
          In a crowded logistics market, Atlas Crossings stands out as a trusted partner that puts your needs first. Here's what sets us apart:
        </WhyChooseText>
        <WhyChooseList>
