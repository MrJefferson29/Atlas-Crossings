...
export default function Sc2() {
  return (
    <Styles>
      ...
      <StorySection>
        <SectionHeading>The Atlas Crossings Inc. Story</SectionHeading>
        <Separator />
        <StoryText>
          Founded with a vision to revolutionize the logistics industry, Atlas Crossings Inc was born from a simple yet powerful idea: to offer innovative, customer-centric solutions that make shipping seamless and stress-free. Our name, Atlas Crossings Inc, reflects our commitment to speed, precision, and reliability—the "Atlas" symbolizing our pursuit of global-degree excellence in every aspect of our service.
        </StoryText>
        <StoryText>
        ...
        <StoryText>
          At ACS, we don't just move packages—we move businesses forward. Whether you're shipping across town or across continents, we're here to be your strategic partner in logistics, providing solutions that are as unique as your needs.
        </StoryText>
      </StorySection>
      ...
      <VisionSection>
        ...
        <Separator />
        <VisionText>
          Atlas Crossings Inc envisions a world where logistics is no longer a barrier to growth, but a catalyst for success. We're committed to leading the industry by embracing innovation, sustainability, and customer-first practices that set new standards for excellence.
        </VisionText>
        <VisionList>
