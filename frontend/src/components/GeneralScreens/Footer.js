    ...
    <FooterContainer>
      <Container>
        <Row>
          <Col md={4}>
            <FooterSection>
              <FooterLogo>Atlas Crossings</FooterLogo>
              <FooterDescription>
                Atlas Crossings, a distinguished logistics company, meticulously
      ...
      <FooterBottom>
        <p>&copy; 2026 Atlas Crossings Inc. All rights reserved.</p>
      </FooterBottom>
    </FooterContainer>
  );
}
